                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6">
                                    ...
                                    <p className="text-lg leading-relaxed mb-4" style={{ fontFamily: 'Jeju Myeongjo' }}>
                                        digital photography that captures moments, emotions, and perspectives through 
                                        the lens. Each image is carefully composed to tell a story or evoke a feeling.
                                    </p>
                                    <p className="text-lg leading-relaxed mb-4" style={{ fontFamily: 'Jeju Myeongjo' }}>
                                        From portraits to landscapes, this collection explores the diverse possibilities 
                                        of photographic expression in the digital medium.
                                    </p>
                                    <div className="border-t pt-4">
                                        <p className="font-semibold" style={{ fontFamily: 'Outfit' }}>Medium:</p>
                                        <p style={{ fontFamily: 'Jeju Myeongjo' }}>Digital Photography</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-center">
                                <img 
                                    src="/elyse-undan/images/photography.jpg" 
                                    alt="Photography"
