            ...
            <div className="bg-orange-300 px-4 py-16 lg:py-24" style={{backgroundColor: '#FFB74D'}}>
                <div className="container mx-auto max-w-6xl">
                    ...
                    <p className="text-xl lg:text-2xl text-black/80 mb-6" style={{ fontFamily: 'Jeju Myeongjo' }}>
                        WICS 2025 Hackathon housing solution platform
                    </p>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-800 leading-relaxed" style={{ fontFamily: 'Jeju Myeongjo' }}>
                                    Drafted and designed front end website using Canva and Figma, built UI with React and collaborated to connect React frontend to Flask backend.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-800" style={{ fontFamily: 'Jeju Myeongjo' }}>
                                    React / Flask / Canva / Figma / Full-stack Development / Team Collaboration
                                </p>
                            </div>
                        </div>
                    </div>
